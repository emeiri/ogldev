...
${OBJECTDIR}/picking_technique.o: picking_technique.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/picking_technique.o picking_technique.cpp

${OBJECTDIR}/picking_texture.o: picking_texture.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/picking_texture.o picking_texture.cpp
...
${OBJECTDIR}/simple_color_technique.o: simple_color_technique.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/simple_color_technique.o simple_color_technique.cpp
...
${OBJECTDIR}/tutorial29.o: tutorial29.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/tutorial29.o tutorial29.cpp
