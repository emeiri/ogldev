...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial42: ../Common/dist/Debug/GNU-Linux-x86/libcommon.a
...
${OBJECTDIR}/tutorial42.o: tutorial42.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -I/usr/local/include/glfx -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tutorial42.o tutorial42.cpp
