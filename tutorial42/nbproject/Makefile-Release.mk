...
LDLIBSOPTIONS=-lglut -lGLEW -lMagick++ -lassimp /usr/lib/libglfx.so -lfontconfig -lfreetype -lGL

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial42

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial42: /usr/lib/libglfx.so
...
${OBJECTDIR}/_ext/2079778815/depth_technique.o: /home/cl/hacking/graphics/opengl/Tutorials/ogldev/tutorial42/depth_technique.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2079778815/depth_technique.o /home/cl/hacking/graphics/opengl/Tutorials/ogldev/tutorial42/depth_technique.cpp
...
${OBJECTDIR}/_ext/2079778815/lighting_technique.o: /home/cl/hacking/graphics/opengl/Tutorials/ogldev/tutorial42/lighting_technique.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2079778815
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2079778815/lighting_technique.o /home/cl/hacking/graphics/opengl/Tutorials/ogldev/tutorial42/lighting_technique.cpp

${OBJECTDIR}/FreetypeGL/font-manager.o: FreetypeGL/font-manager.c 
	${MKDIR} -p ${OBJECTDIR}/FreetypeGL
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -I/usr/include/freetype2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FreetypeGL/font-manager.o FreetypeGL/font-manager.c
...
${OBJECTDIR}/FreetypeGL/texture-atlas.o: FreetypeGL/texture-atlas.c 
	${MKDIR} -p ${OBJECTDIR}/FreetypeGL
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -I/usr/include/freetype2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FreetypeGL/texture-atlas.o FreetypeGL/texture-atlas.c

${OBJECTDIR}/FreetypeGL/texture-font.o: FreetypeGL/texture-font.c 
	${MKDIR} -p ${OBJECTDIR}/FreetypeGL
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -I/usr/include/freetype2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FreetypeGL/texture-font.o FreetypeGL/texture-font.c

${OBJECTDIR}/FreetypeGL/texture-glyph.o: FreetypeGL/texture-glyph.c 
	${MKDIR} -p ${OBJECTDIR}/FreetypeGL
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -I/usr/include/freetype2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FreetypeGL/texture-glyph.o FreetypeGL/texture-glyph.c

${OBJECTDIR}/FreetypeGL/vector.o: FreetypeGL/vector.c 
	${MKDIR} -p ${OBJECTDIR}/FreetypeGL
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -I/usr/include/freetype2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FreetypeGL/vector.o FreetypeGL/vector.c

${OBJECTDIR}/FreetypeGL/vertex-buffer.o: FreetypeGL/vertex-buffer.c 
	${MKDIR} -p ${OBJECTDIR}/FreetypeGL
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -I/usr/include/freetype2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FreetypeGL/vertex-buffer.o FreetypeGL/vertex-buffer.c
...
${OBJECTDIR}/intermediate_buffer.o: intermediate_buffer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/intermediate_buffer.o intermediate_buffer.cpp
...
${OBJECTDIR}/motion_blur_technique.o: motion_blur_technique.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/motion_blur_technique.o motion_blur_technique.cpp
...
${OBJECTDIR}/tutorial42.o: tutorial42.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/tutorial42.o tutorial42.cpp
