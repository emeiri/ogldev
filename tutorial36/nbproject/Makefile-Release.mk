...
LDLIBSOPTIONS=-lglut -lGLEW -lMagick++ -lassimp /usr/local/lib/libglfx.so

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial36

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial36: /usr/local/lib/libglfx.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial36: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial36 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/ds_dir_light_pass_tech.o: ds_dir_light_pass_tech.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/ds_dir_light_pass_tech.o ds_dir_light_pass_tech.cpp

${OBJECTDIR}/ds_geom_pass_tech.o: ds_geom_pass_tech.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/ds_geom_pass_tech.o ds_geom_pass_tech.cpp

${OBJECTDIR}/ds_light_pass_tech.o: ds_light_pass_tech.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/ds_light_pass_tech.o ds_light_pass_tech.cpp

${OBJECTDIR}/ds_point_light_pass_tech.o: ds_point_light_pass_tech.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/ds_point_light_pass_tech.o ds_point_light_pass_tech.cpp

${OBJECTDIR}/gbuffer.o: gbuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/gbuffer.o gbuffer.cpp
...
${OBJECTDIR}/tutorial36.o: tutorial36.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/tutorial36.o tutorial36.cpp
