...
${OBJECTDIR}/cubemap_texture.o: cubemap_texture.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -I/usr/local/include/assimp -MMD -MP -MF $@.d -o ${OBJECTDIR}/cubemap_texture.o cubemap_texture.cpp
...
${OBJECTDIR}/skybox.o: skybox.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -I/usr/local/include/assimp -MMD -MP -MF $@.d -o ${OBJECTDIR}/skybox.o skybox.cpp

${OBJECTDIR}/skybox_technique.o: skybox_technique.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -I/usr/local/include/assimp -MMD -MP -MF $@.d -o ${OBJECTDIR}/skybox_technique.o skybox_technique.cpp
...
${OBJECTDIR}/tutorial25.o: tutorial25.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -I/usr/local/include/assimp -MMD -MP -MF $@.d -o ${OBJECTDIR}/tutorial25.o tutorial25.cpp
