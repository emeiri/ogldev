...
$CC tutorial47.cpp \
    ...
    $ROOTDIR/Common/ogldev_billboard_list.cpp \
    $ROOTDIR/Common/ogldev_billboard_technique.cpp \
    $ROOTDIR/Common/ogldev_bezier_curve_technique.cpp \
    $ROOTDIR/Common/ogldev_passthru_vec2_technique.cpp \
    $OGL_CPPFLAGS $OGL_LDFLAGS -o tutorial47
