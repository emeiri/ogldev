...
#define MOTION_TEXTURE_UNIT             GL_TEXTURE6
#define MOTION_TEXTURE_UNIT_INDEX       6
#define SPECULAR_EXPONENT_UNIT             GL_TEXTURE7
#define SPECULAR_EXPONENT_UNIT_INDEX       7
