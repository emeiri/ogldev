...
$CC tutorial50.cpp ../Common/ogldev_vulkan.cpp ../Common/ogldev_vulkan_core.cpp ../Common/ogldev_xcb_control.cpp ../Common/math_3d.cpp ../Common/ogldev_util.cpp $CPPFLAGS $LDFLAGS -o tutorial50
