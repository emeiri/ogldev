...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial27: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial27 ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/billboard_list.o: billboard_list.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -I/usr/local/include/assimp -MMD -MP -MF $@.d -o ${OBJECTDIR}/billboard_list.o billboard_list.cpp

${OBJECTDIR}/billboard_technique.o: billboard_technique.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -I/usr/local/include/assimp -MMD -MP -MF $@.d -o ${OBJECTDIR}/billboard_technique.o billboard_technique.cpp
...
${OBJECTDIR}/tutorial27.o: tutorial27.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -I/usr/local/include/assimp -MMD -MP -MF $@.d -o ${OBJECTDIR}/tutorial27.o tutorial27.cpp
