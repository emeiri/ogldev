...
${OBJECTDIR}/billboard_list.o: billboard_list.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/assimp -I../Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/billboard_list.o billboard_list.cpp

${OBJECTDIR}/billboard_technique.o: billboard_technique.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/assimp -I../Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/billboard_technique.o billboard_technique.cpp
...
${OBJECTDIR}/tutorial27.o: tutorial27.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/assimp -I../Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tutorial27.o tutorial27.cpp
