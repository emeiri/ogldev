...
LDLIBSOPTIONS=-lglut -lGLEW -lMagick++ -lassimp -lGL -lfontconfig -lfreetype ../Common/dist/Debug/GNU-Linux-x86/libcommon.a
...
${OBJECTDIR}/lighting_technique.o: lighting_technique.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lighting_technique.o lighting_technique.cpp
...
${OBJECTDIR}/tutorial33.o: tutorial33.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tutorial33.o tutorial33.cpp
