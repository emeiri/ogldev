...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial24: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial24 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/shadow_map_fbo.o: shadow_map_fbo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/shadow_map_fbo.o shadow_map_fbo.cpp

${OBJECTDIR}/shadow_map_technique.o: shadow_map_technique.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/shadow_map_technique.o shadow_map_technique.cpp
...
${OBJECTDIR}/tutorial24.o: tutorial24.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/tutorial24.o tutorial24.cpp
