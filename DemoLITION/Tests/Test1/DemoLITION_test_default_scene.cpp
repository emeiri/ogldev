...
private:
    ...
    void InitMesh()
    {
        ...
        m_pSceneObject1->SetPosition(0.0f, 1.0f, 10.0f);
        ...
        m_pSceneObject2->SetPosition(10.0f, 1.0f, 0.0f);
        ...
        m_pSceneObject3->SetPosition(-10.0f, 1.0f, 0.0f);
        ...
        m_pSceneObject4->SetPosition(0.0f, 1.0f, -10.0f);
