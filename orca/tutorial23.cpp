...
bool Tutorial23::Init()
{
    ...
    if (!pMesh1->LoadMesh("/home/emeiri/projects/Bistro_v5_2/BistroExterior.fbx")) {
        return false;
    }
...
void Tutorial23::RenderSceneCB()
{
    ...
    meshWorldTransform.SetScale(0.1f);
    meshWorldTransform.SetRotation(270.0f, 90.0f, 0.0f);
    ...
    Vector3f CameraLocalPos3f = meshWorldTransform.WorldPosToLocalPos(pGameCamera->GetPos());
