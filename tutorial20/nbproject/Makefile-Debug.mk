...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial20: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial20 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/tutorial20.o: tutorial20.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/ImageMagick -MMD -MP -MF $@.d -o ${OBJECTDIR}/tutorial20.o tutorial20.cpp
