...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial30: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial30 ${OBJECTFILES} ${LDLIBSOPTIONS} `pkg-config --libs glew ImageMagick++ assimp`
...
${OBJECTDIR}/tutorial30.o: tutorial30.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -I../Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tutorial30.o tutorial30.cpp
