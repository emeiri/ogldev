/*
	...
	Vulkan For Beginners - 
		Tutorial #29: Specialization Constants
*/
...
public:
	...
	void Init(const char* pAppName)
	{
        ...
        m_vkCore.Init(pAppName, m_pWindow, OgldevVK::OGLDEV_VK_INIT_DEPTH_ENABLED);
...
private:
	...
	void CreateMesh()
	{
		m_model.Init(&m_vkCore, true, false);
