...
CC=g++
CPPFLAGS="-I../../Include/assimp6 -I../../Common -I../../DemoLITION/Framework/Include/ -I../VulkanCore/Include -I../../Include  -I$VULKAN_SDK/include -DOGLDEV_VULKAN -ggdb3 -std=c++20"
LDFLAGS=`pkg-config --libs glfw3 vulkan`
LDFLAGS="$LDFLAGS -L../../Lib/assimp6 -L../../Lib -L$VULKAN_SDK/lib -lassimp -lglslang -lglslang-default-resource-limits -lSPIRV -lOGLCompiler -lOSDependent -lSPVRemapper -lspirv-cross-reflect ../../Lib/libspirv-reflect-static.a ../../Lib/libmeshoptimizer.a"
$CC tutorial20.cpp \
