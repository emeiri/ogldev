...
LDFLAGS="$LDFLAGS -L../../Lib -L../../Lib -L$VULKAN_SDK/lib -lassimp -lglslang -lglslang-default-resource-limits -lSPIRV -lOSDependent -lSPVRemapper -lspirv-cross-reflect -lmeshoptimizer"
$CC tutorial20.cpp \
