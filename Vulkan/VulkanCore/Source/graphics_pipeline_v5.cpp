...
GraphicsPipelineV5::GraphicsPipelineV5(const PipelineDesc& pd)
{
	if (pd.IsTexCube) {
		printf("GraphicsPipelineV5 doesn't support texcubes. Use GraphicsPipelineV2 instead.");
		exit(1);
	}
...
GraphicsPipelineV5::~GraphicsPipelineV5()
{
...
void GraphicsPipelineV5::Bind(VkCommandBuffer CmdBuf)
{
	vkCmdBindPipeline(CmdBuf, VK_PIPELINE_BIND_POINT_GRAPHICS, m_pipeline);
}


void GraphicsPipelineV5::InitCommon(GLFWwindow* pWindow, VkRenderPass RenderPass, 
...
void GraphicsPipelineV5::CreateDescriptorPool(u32 TextureCount, 
...
void GraphicsPipelineV5::CreateDescriptorSetLayout(bool IsVB, bool IsIB, bool IsTex, bool IsUniform)
{
...
void GraphicsPipelineV5::AllocateDescriptorSets(std::vector<VkDescriptorSet>& DescriptorSets)
{
...
void GraphicsPipelineV5::AllocateDescriptorSetsInternal(std::vector<VkDescriptorSet>& DescriptorSets)
{
