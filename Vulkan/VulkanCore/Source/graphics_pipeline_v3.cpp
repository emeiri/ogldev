...
GraphicsPipelineV3::GraphicsPipelineV3(const GraphicsPipelineDesc& pd)
{
	if (pd.IsTexCube) {
...
GraphicsPipelineV3::~GraphicsPipelineV3()
{
...
void GraphicsPipelineV3::Bind(VkCommandBuffer CmdBuf)
{
	vkCmdBindPipeline(CmdBuf, VK_PIPELINE_BIND_POINT_GRAPHICS, m_pipeline);
}


void GraphicsPipelineV3::InitCommon(GLFWwindow* pWindow, VkRenderPass RenderPass, 
...
void GraphicsPipelineV3::CreateDescriptorPool(u32 TextureCount, 
...
void GraphicsPipelineV3::AllocateDescriptorSets(int NumSubmeshes, 
...
void GraphicsPipelineV3::AllocateTextureDescriptorSet(VkDescriptorSet& TexturesDescriptorSet)
{
	VkDescriptorSetAllocateInfo AllocInfo = {
		.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO,
		.pNext = NULL,
...
void GraphicsPipelineV3::UpdateDescriptorSets(const ModelDesc& ModelDesc,
											  std::vector<std::vector<VkDescriptorSet>>& DescriptorSets,
											  VkDescriptorSet& TexturesDescriptorSet)
{
...
void GraphicsPipelineV3::UpdateTexturesDescriptorSet(const ModelDesc& ModelDesc, 
													 VkDescriptorSet& TexturesDescriptorSet)
{
