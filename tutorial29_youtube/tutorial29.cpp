/*
    ...
    Tutorial 29 - Vertex Pipeline Finale
*/
...
void Tutorial29::KeyboardCB(unsigned char key, int mouse_x, int mouse_y)
{
    switch (key) {
    case 'q':
...
void Tutorial29::SpecialKeyboardCB(int key, int mouse_x, int mouse_y)
{
    pGameCamera->OnKeyboard(key);
}
...
void KeyboardCB(unsigned char key, int mouse_x, int mouse_y)
{
    pTutorial29->KeyboardCB(key, mouse_x, mouse_y);
}


void SpecialKeyboardCB(int key, int mouse_x, int mouse_y)
{
    pTutorial29->SpecialKeyboardCB(key, mouse_x, mouse_y);
}
