...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tutorial38: /usr/local/lib/libglfx.so
...
${OBJECTDIR}/skinning_technique.o: skinning_technique.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -I/usr/local/include/glfx -MMD -MP -MF $@.d -o ${OBJECTDIR}/skinning_technique.o skinning_technique.cpp
...
${OBJECTDIR}/tutorial38.o: tutorial38.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/include/ImageMagick -I/usr/local/include/assimp -I/usr/include/freetype2 -IFreetypeGL -I/usr/local/include/glfx -MMD -MP -MF $@.d -o ${OBJECTDIR}/tutorial38.o tutorial38.cpp
